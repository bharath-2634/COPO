...
const AddSubject = () => {
    ...
    const subjectApi = async (e) => {
        ...
        // if(courseOutcome=="") {
        //     setError("courseOutcome required");
        //     return;
        // }
  ...
  return (
    <>
      <div className='flex w-full items-center justify-between'>
        ...
        <div>
            <button className='flex items-center justify-center gap-4 bg-green-500 p-3 text-white rounded font-medium' onClick={()=>{setOpenModal(true)}}>
                <h2>Add</h2>
                ...
                className="w-[50%] max-h-2/4 bg-white rounded-md mx-auto mt-5 p-5 ">
                    <div className='flex flex-col p-1 gap-2'>
                        <div className='w-full flex items-center justify-between'>
                            <h2>Add Subject</h2>
                            <button className='w-10 h-10 rounded-full flex items-center justify-center -mt-2 hover:bg-slate-50' onClick={(e)=>{setOpenModal(false)}}>
                        ...
                        <form>
                            ...
                            <div className='flex flex-col gap-2 mt-3'>
                                <h3 className='text-sm text-slate-400 font-medium'>Course outcome</h3>
                                <input type="text" className='block w-full rounded-md border-0 py-1.5 pl-7 pr-20 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400  sm:text-sm/6' value={courseOutcome} onChange={(e)=>{setCourseOutcome(e.target.value)}} placeholder="eg. speak clearly ..."/>
                            </div>
                            <div className='flex items-center justify-center w-full ml-10 mt-10'>
                                <div className='grid grid-rows-3 grid-cols-3 w-full gap-3'>
                                    <div className='flex items-center gap-3'>
                                        <h2>PO1</h2>
                                        <input type="text" className='w-16 rounded-md border-0 py-1 px-3 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400  sm:text-sm/6' value={PO1} onChange={(e)=>{setPo1(e.target.value)}} placeholder="eg. 0"/>
                                    </div>
                                    <div className='flex items-center gap-3'>
                                        <h2>PO2</h2>
                                        <input type="text" className='w-16 rounded-md border-0 py-1 px-3 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400  sm:text-sm/6' value={PO2} onChange={(e)=>{setPo2(e.target.value)}} placeholder="eg. 0"/>
                                    </div>
                                    <div className='flex items-center gap-3'>
                                        <h2>PO3</h2>
                                        <input type="text" className='w-16 rounded-md border-0 py-1 px-3 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400  sm:text-sm/6' value={PO3} onChange={(e)=>{setPo3(e.target.value)}} placeholder="eg. 0"/>
                                    </div>
                                    <div className='flex items-center gap-3'>
                                        <h2>PO4</h2>
                                        <input type="text" className='w-16 rounded-md border-0 py-1 px-3 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400  sm:text-sm/6' value={PO4} onChange={(e)=>{setPo4(e.target.value)}} placeholder="eg. 0"/>
                                    </div>
                                    <div className='flex items-center gap-3'>
                                        <h2>PO5</h2>
                                        <input type="text" className='w-16 rounded-md border-0 py-1 px-3 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400  sm:text-sm/6' value={PO5} onChange={(e)=>{setPo5(e.target.value)}} placeholder="eg. 0"/>
                                    </div>
                                    <div className='flex items-center gap-3'>
                                        <h2>PO6</h2>
                                        <input type="text" className='w-16 rounded-md border-0 py-1 px-3 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400  sm:text-sm/6' value={PO6} onChange={(e)=>{setPo6(e.target.value)}} placeholder="eg. 0"/>
                                    </div>
                                    <div className='flex items-center gap-3'>
                                        <h2>PO7</h2>
                                        <input type="text" className='w-16 rounded-md border-0 py-1 px-3 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400  sm:text-sm/6' value={PO7} onChange={(e)=>{setPo7(e.target.value)}} placeholder="eg. 0"/>
                                    </div>
                                    <div className='flex items-center gap-3'>
                                        <h2>PO8</h2>
                                        <input type="text" className='w-16 rounded-md border-0 py-1 px-3 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400  sm:text-sm/6' value={PO8} onChange={(e)=>{setPo8(e.target.value)}} placeholder="eg. 0"/>
                                    </div>
                                    <div className='flex items-center gap-3'>
                                        <h2>PO9</h2>
                                        <input type="text" className='w-16 rounded-md border-0 py-1 px-3 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400  sm:text-sm/6' value={PO9} onChange={(e)=>{setPo9(e.target.value)}} placeholder="eg. 0"/>
                                    </div>
                                    <div className='flex items-center gap-3'>
                                        <h2>PO10</h2>
                                        <input type="text" className='w-16 rounded-md border-0 py-1 px-3 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400  sm:text-sm/6' value={PO10} onChange={(e)=>{setPo10(e.target.value)}} placeholder="eg. 0"/>
                                    </div>
                                    <div className='flex items-center gap-3'>
                                        <h2>PO11</h2>
                                        <input type="text" className='w-16 rounded-md border-0 py-1 px-3 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400  sm:text-sm/6' value={PO11} onChange={(e)=>{setPo11(e.target.value)}} placeholder="eg. 0"/>
                                    </div>
                                    <div className='flex items-center gap-3'>
                                        <h2>PO12</h2>
                                        <input type="text" className='w-16 rounded-md border-0 py-1 px-3 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400  sm:text-sm/6' value={PO12} onChange={(e)=>{setPo12(e.target.value)}} placeholder="eg. 0"/>
                                    </div>
                                </div>
                            </div>
                            {error && (<p className='text-red-500 text-xs pt-4'>{error}</p>)}
                            <div className='w-full flex items-center justify-end mt-10'>
                                <button className='px-10flex bg-green-500 p-2 text-white rounded' onClick={(e)=>{handleSubjectData(e)}}>
                                    Add data
                                </button>
                            </div>
                        </form>
      ...
      <div>
        <table className="min-w-full border border-gray-300 bg-white rounded-lg shadow-md overflow-hidden table-fixed mt-10">
            <thead className="bg-gray-200 text-gray-700">
                <tr>
                <th className="w-1/4 px-3 py-3 text-left text-xs font-medium uppercase tracking-wider">{cono}</th>
            ...
            <tbody className="text-gray-600">
                {
                    subjectData.map(({cono,courseOutcome,PO1,PO2,PO3,PO4,PO5,PO6,PO7,PO8,PO9,PO10,PO11,PO12},idx)=>{
                        return (
      ...
      <div className='flex w-full items-center justify-end mt-10'>
        <button className='flex items-center justify-center gap-3 bg-green-600 p-2 text-white rounded font-medium' onClick={(e)=>{subjectApi(e)}}>
            <FiUpload />
            <h2>Upload Data</h2>
        </button>
      </div>
