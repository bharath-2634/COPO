...
const Mapping = () => {
    ...
    const getSubjectMapping = async()=>{
        ...
        try {
            ...
            const response = await axiosInstance.get("/getSubjectMapping/"+batchId+"/"+encodedCourseNumber+"/"+encodedSubjectName , {
                headers: {
                    Authorization: `Bearer ${token}`,
                },
            })
  ...
  return (
    <>
      ...
      <div>
        {
            (supportTag && subjectData.length===0) ? (<p> No Data found</p>) : (
                                ...
                                <tbody>
                                    {
                                        ...
                                        subjectMapData.map(({cono,courseOutcome,PO1,PO2,PO3,PO4,PO5,PO6,PO7,PO8,PO9,PO10,PO11,PO12},idx)=>{
